...
{elseif $cachetype==13}
	<img src="resource2/{$opt.template.style}/images/cacheicon/challenge.png" alt="{t}Challenge Geocache{/t}" border="0" width="22" height="22" align="left" style="margin-right: 5px;" />
{elseif $cachetype==14}
	<img src="resource2/{$opt.template.style}/images/cacheicon/guestbook.png" alt="{t}Guest book Geocache{/t}" border="0" width="22" height="22" align="left" style="margin-right: 5px;" />
{else}
	&nbsp;
{/if}
{/strip}