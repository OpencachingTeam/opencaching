...
<div class="content2-container line-box">
	<div class="">
		...
		<div class="content2-container-2col-left" id="cache_name_block">
			...
			{if $cache.type==6}
				<span class="participants"><img src="resource2/{$opt.template.style}/images/cacheicon/16x16-event.gif" width="16" height="16" alt="{t}List of participants{/t}" />&nbsp;<a href="#" onClick="javascript:window.open('event_attendance.php?id={$cache.cacheid}&popup=y','{t escape=js}List of participants{/t}','width=320,height=440,resizable=no,scrollbars=1')">{t}List of participants{/t}</a></span>
			{/if}
		</div>
	</div>
</div>
...
<div class="content2-container">
	<div class="content2-container-2col-left" id="viewcache-baseinfo">
		...
		<p style="line-height: 1.6em;">
			<img src="resource2/{$opt.template.style}/images/viewcache/map.png" class="icon16" alt="" title="" align="middle" />&nbsp;<a href="#" onClick="javascript:window.open('coordinates.php?lat={$cache.latitude}&lon={$cache.longitude}&popup=y&wp={$cache.wpoc}','{t escape=js}Coordinates{/t}','width=280,height=394,resizable=no,scrollbars=0')">{t}Convert coordinates{/t}</a><br />
			...
			<img src="resource2/{$opt.template.style}/images/viewcache/date.png" class="icon16" alt="" title="" align="middle" />&nbsp;{t}Hidden at{/t}: {$cache.datehidden|date_format:$opt.format.datelong}<br />
		...
		<p>
			...
			<select name="wpdownload" class="wpdownload" onChange="location.href=this.options[this.selectedIndex].value"> 
				...
				<option value="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&f_ignored=0&startat=0&cacheid={$cache.cacheid}&output=gpxv1">GPX v1</option>
				<option value="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&f_ignored=0&startat=0&cacheid={$cache.cacheid}&output=gpxv2">GPX v2</option>
...
<div class="content2-container">
	{if count($npaareasWarning) > 0}
		<div style="border: solid 1px red;padding:10px;">
			<p style="line-height: 1.6em;">
				...
				{t}This geocache is probably placed within a nature protection area! See <a href="http://cms.opencaching.de/index.php?id=140">here</a> for further informations, please.{/t}<br />
	...
	{if count($npaareasNoWarning) > 0}
		<p style="line-height: 1.6em;">
			{t}This geocache is probably placed within the following nature protection areas (<a href="http://cms.opencaching.de/index.php?id=140">Info</a>):{/t}
