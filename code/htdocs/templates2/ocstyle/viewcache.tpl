	...
	<div class="content2-container-2col-left" id="viewcache-baseinfo">
		...
		<p>
			...
			<select name="wpdownload" class="wpdownload" onChange="location.href=this.options[this.selectedIndex].value"> 
				...
				<option value="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&startat=0&cacheid={$cache.cacheid}&output=gpx">GPX</option>
...
<div class="content2-container">
	...
	{if $print!=true}
		<p>
			...
			<a href="search.php?searchto=searchbycacheid&showresult=1&f_inactive=0&startat=0&cacheid={$cache.cacheid}&output=gpx" title="{t}GPS Exchange Format .gpx{/t}">GPX</a> - 
