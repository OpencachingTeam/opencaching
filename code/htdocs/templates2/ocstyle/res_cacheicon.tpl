...
{elseif $cachetype==11}
	<img src="resource2/{$opt.template.style}/images/cacheicon/mocache.gif" alt="{t}Motocycle Geocache{/t}" border="0" width="32" height="32" class="icon32" id="viewcache-cacheicon" />
{else}
	&nbsp;
{/if}
