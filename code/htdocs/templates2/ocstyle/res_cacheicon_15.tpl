...
{elseif $cachetype==11}
	<img src="resource2/{$opt.template.style}/images/cacheicon/podcache.png" alt="{t}Podcast Geocache{/t}" border="0" width="15" height="15" align="left" style="margin-right: 5px; padding-left: 25px;" />
{elseif $cachetype==12}
