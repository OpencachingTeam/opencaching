  ...
  <table class="table">
    <tr>
      <td>{t}Note:{/t}</td>
      <td>
        <input type="checkbox" name="incl_coord" value="true" {if $inclCoord}checked="checked"{/if}/>{t}Include a coordinate in the note{/t}
      </td>
    </tr>
    <tr>
      <td>
        <textarea name="note" rows="2" cols="60" >{$note}</textarea>
      </td>
      <td>
