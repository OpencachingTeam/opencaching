...
<div class="content-txtbox-noshade">
	...
	<p style="line-height: 1.6em;">
		...
		{elseif $id==ERROR_NO_COOKIES}
			({$id}) {t}Your browser has rejected our cookie.<br />
			You can find more informations about this topic in the <a href="http://cms.opencaching.de/index.php?id=login">Opencaching.de-help</a>.{/t}
