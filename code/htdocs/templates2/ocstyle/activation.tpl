	...
	<form action="activation.php" method="post" enctype="application/x-www-form-urlencoded" style="display: inline;">
	  ...
	  <p style="line-height: 1.6em;">
		...
		{if $errorAlreadyActivated==true}
			<p style="line-height: 1.6em;">
				{t}The account is already activated. Please try to <a href="login.php">login</a>.<br />
				If you cannot login, please read the following page: <a href="http://cms.opencaching.de/index.php?id=login">problems with login</a>{/t}
		  </p>
		{/if}
